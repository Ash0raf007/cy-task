        ...
        <div className="w-[329px] h-[943px] rounded-xl border bg-white ">
          ...
          <div className="flex justify-center">
            <div className="flex flex-col p-4">
              ...
              <div
                className={`flex items-center justify-between mt-[20px] cursor-pointer rounded  ${isEmployeesOpen ? 'bg-[#F9EAEB] text-[#EC232B] pr-[10px]  rounded-r-xl py-[5px] ' : 'bg-white'}`}
                onClick={() => setIsEmployeesOpen((isEmployeesOpen) => !isEmployeesOpen)}
              >
                <div className="flex items-center">
                  {isEmployeesOpen ? <p className="bg-[#EC232B] w-[5px] h-[35px] mr-[40px]"> </p> : ""}
                  <Image src="/clarity_employee-group-line.svg" width={26} height={26} alt="employees" />
                  <span className="ml-[10px] pr-[20px]">Employees</span>
                </div>
